...
def get_average_star_rate():
    ...
    global zero_stars_comments
    global one_star_comments
    global two_stars_comments
    global three_stars_comments
    global four_stars_comments
    global five_stars_comments

    with DataBase() as db:
        db.insert_review(star_rate, user_name, review_comment)
        avg_star_rate = db.select_avg_starrate()
        zero_stars_comments = db.select_review_comment(0)
        one_star_comments = db.select_review_comment(1)
        two_stars_comments = db.select_review_comment(2)
        three_stars_comments = db.select_review_comment(3)
        four_stars_comments = db.select_review_comment(4)
        five_stars_comments = db.select_review_comment(5)
...
def read_next_page():
    ...
    #     zero_stars=zero_stars_comments,
    #     one_star=one_star_comments,
    #     two_stars=two_stars_comments,
    #     three_stars=three_stars_comments,
    #     four_stars=four_stars_comments,
    #     five_stars=five_stars_comments
    #     )