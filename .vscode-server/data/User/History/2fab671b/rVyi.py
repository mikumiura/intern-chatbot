...
def submit_data():
    ...
    with DataBase() as db:
        ...
        # highly_rated_comment = db.select_highlyrated_comment()
...
def read_next_page():
    ...
    # return render_template("next-page.html", avg_star_rate=avg_star_rate, comment1=highly_rated_comment)