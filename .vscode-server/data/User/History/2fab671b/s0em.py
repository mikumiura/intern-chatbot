...
def submit_data():
    ...
    with DataBase() as db:
        ...
        comment_list = db.select_review_comment(3)
...
def read_next_page():
    ...
    return render_template(
        ...
        # zero_stars=zero_star_comment,
        # one_star=one_star_comment,
        # two_stars=two_star_comment,
        # three_stars=three_star_comment,
        # four_stars=four_star_comment,
        # five_stars=five_star_comment
        )