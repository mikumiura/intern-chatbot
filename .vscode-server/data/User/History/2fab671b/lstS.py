...
def read_next_page():
    ...
    # return render_template("next-page.html", avg_star_rate=avg_star_rate, comment1=highly_rated_comment[0], comment2=highly_rated_comment[1], comment3=highly_rated_comment[2])