...
def read_first_page():
    ...
    # index.htmlファイルを読み込んでreturnする方法
...
def submit_data():
    ...
    global avg_star_rate, zero_star_comment, one_star_comment, two_star_comment, three_star_comment, four_star_comment, five_star_comment

    with DataBase() as db:
        db.insert_review(star_rate, review_comment)
        avg_star_rate = db.select_avg_starrate()
        zero_star_comment = db.select_review_comment(0)
        one_star_comment = db.select_review_comment(1)
        two_star_comment = db.select_review_comment(2)
        three_star_comment = db.select_review_comment(3)
        four_star_comment = db.select_review_comment(4)
        five_star_comment = db.select_review_comment(5)
...
def read_next_page():
    ...
    return render_template(
        ...
        zero_star_comment=zero_star_comment,
        one_star_comment=one_star_comment,
        two_star_comment=two_star_comment,
        three_star_comment=three_star_comment,
        four_star_comment=four_star_comment,
        five_star_comment=five_star_comment
        )