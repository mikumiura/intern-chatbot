...
def google_search(user_id, reply_token):
    ...
    if words_id == None:
        ...
        with Google() as g:
            g.search(word)
            url_list = g.get_url()
            other_keyword_list = g.get_other_keyword()
                            ...
                            "items": [
                                {
                                    ...
                                    "action": {
                                        "type": "message",
                                        "label": other_keyword_list[0],
                                        "text": other_keyword_list[0]
                                    }
                                },
                                {
                                    "type": "action",
                                    "action": {
                                        "type": "message",
                                        "label": other_keyword_list[1],
                                        "text": other_keyword_list[1]
                                    }
                                },
                                {
                                    "type": "action",
                                    "action": {
                                        "type": "message",
                                        "label": other_keyword_list[2],
                                        "text": other_keyword_list[2]
                                    }
                                },
                                {
                                    "type": "action",
    ...
    # 入力ワードの検索履歴がDBにあったとき
        ...
        # googleでの検索履歴がDBにあったとき
            ...
            if word_andsearch == None:
                ...
                for i in range(len(word_andsearch)):
                    post_to_line(
                        reply_token,
                        [
                            {
